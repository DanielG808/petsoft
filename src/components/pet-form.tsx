    ...
    >
      <div className="space-y-3">
        ...
        <div className="space-y-1">
          ...
          {errors.ownerName && (
            <p className="text-red-500 italic">{errors.ownerName.message}</p>
          )}
        </div>
        ...
        <div className="space-y-1">
          ...
          {errors.imageUrl && (
            <p className="text-red-500 italic">{errors.imageUrl.message}</p>
          )}
        </div>
        ...
        <div className="space-y-1">
          ...
          {errors.notes && (
            <p className="text-red-500 italic">{errors.notes.message}</p>
          )}
        </div>
      </div>
